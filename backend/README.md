...
## Project Structure
    ...
    ├── testapiautostoryboa_68136  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_68136`
...
2. Clone this repo and `cd testapiautostoryboa_68136`
